...
class Controller(Node):
    ...
    def app_on_select(self,num):
        ...
        for i in range(17):
            #num과 같은 제품의 상태를 변경
            self.app_control_msg.data[i]= 1 if (i == num) else 0;
    ...
    def app_off_select(self,num):
        ...
        for i in range(17):
            #num과 같은 제품의 상태를 변경
            self.app_control_msg.data[i]= 2 if (i == num) else 0;
    ...
    def timer_callback(self):
        ...
        가전 제품 : 가전상태 출력        
        '''
        print("Turtlebot : ", self.turtlebot_status_msg)
        print("Environment : ", self.envir_status_msg)
        print("App : ", self.app_status_msg)
